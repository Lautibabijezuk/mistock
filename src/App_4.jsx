    ...
    <div style={{ fontFamily: font, color: C.ink, background: C.bg, minHeight: "100vh" }}>
        ...
        <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 60, alignItems: "center" }}>
          <div>
            <h1 className="hero-h1" style={{ fontSize: 68, lineHeight: 1.02, fontWeight: 500, letterSpacing: "-2.5px", margin: "0 0 24px" }}>
              Controlá stock, ventas y ganancias en un solo lugar
            </h1>
            <p style={{ fontSize: 18, lineHeight: 1.55, color: C.body, margin: "0 0 32px", maxWidth: 520 }}>
              MiStock está pensado para comercios argentinos que venden productos físicos todos los días. Organizá tu operación, registrá ventas y facturá con AFIP desde un solo lugar.
            </p>
      ...
      <section style={{ ...wrap, padding: "40px 24px 80px" }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 60px" }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: C.purple, letterSpacing: "1px", textTransform: "uppercase", marginBottom: 14 }}>Nuestra propuesta</div>
          ...
          <p style={{ fontSize: 17.5, lineHeight: 1.6, color: C.body, margin: 0 }}>
            MiStock te da más que control de stock: te da datos para tomar mejores decisiones. Descubrí qué días vendés más, qué productos te dejan más ganancia y cuáles te están frenando el negocio.
          </p>
        </div>
      ...
      <section style={{ background: C.bgSoft, padding: "90px 0", borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}` }}>
        <div style={{ ...wrap }}>
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            <div style={{ fontSize: 13, fontWeight: 600, color: C.purple, letterSpacing: "1px", textTransform: "uppercase", marginBottom: 14 }}>¿Cómo funciona?</div>
      ...
      <section style={{ ...wrap, padding: "90px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 50 }}>
          ...
          <h2 style={{ fontSize: 46, lineHeight: 1.05, fontWeight: 500, letterSpacing: "-1.5px", margin: "0 0 14px" }}>Un solo plan, todo incluido</h2>
          <p style={{ fontSize: 17, color: C.body, margin: 0 }}>Sin planes complicados. Un precio simple para que uses todo el sistema.</p>
        </div>
      ...
      <section style={{ background: C.bgSoft, padding: "90px 0", borderTop: `1px solid ${C.line}` }}>
        <div style={{ maxWidth: 780, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 50 }}>
            ...
            <h2 style={{ fontSize: 46, lineHeight: 1.05, fontWeight: 500, letterSpacing: "-1.5px", margin: 0 }}>¿Tenés dudas?</h2>
          </div>
          {faqs.map((f, i) => (
      ...
      <section style={{ background: C.ink, color: "#fff", padding: "90px 0" }}>
        <div style={{ ...wrap, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, color: "#c9c9c9", maxWidth: 560, margin: "0 auto 40px" }}>
            Creá tu cuenta en minutos y probá todo el sistema. Si tenés dudas, escribinos por WhatsApp.
          </p>
